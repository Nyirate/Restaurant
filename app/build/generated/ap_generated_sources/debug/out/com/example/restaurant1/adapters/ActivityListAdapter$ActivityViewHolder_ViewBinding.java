...
public class ActivityListAdapter$ActivityViewHolder_ViewBinding implements Unbinder {
  private ActivityListAdapter.ActivityViewHolder target;

  @UiThread
  public ActivityListAdapter$ActivityViewHolder_ViewBinding(
      ActivityListAdapter.ActivityViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ActivityListAdapter.ActivityViewHolder target = this.target;
